...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('date', models.DateField(help_text=b'due date')),
        ...
        migrations.AddField(
            model_name='opportunity',
            name='user',
            field=models.ForeignKey(help_text=b'The user that is assigned to this opportunity', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='calllog',
            name='opportunity',
